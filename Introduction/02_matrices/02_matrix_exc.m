...
% b. Replace all values in columns 3 and 9, as well as in the last column of your matrix, by NaNs
...
% and in the subsequent rows the data of the players who give fewer than 1 assists per game


%% Exercise 7   - ? (15-20 min)

% a. Given the previous matrix "team"
% Create a new matrix "teamSorted" that contains the data of "team" but in an ascending order of the players' age.
...
% For instance, can you have a script that it *always* gets the last 6 elements of a matrix, even if the size of matrix Q changes?
